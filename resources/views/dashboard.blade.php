                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card stats-wrapper info-card">
                                        <div class="card-body stats">
                                            ...
                                            <h3 class="mb-0">{{ $totle_cancel_order ?? 0 }} <span class="text-success text-sm">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card stats-wrapper info-card">
                                        <div class="card-body stats">
                                            ...
                                            <h3 class="mb-0">{{ SetNumberFormat($total_revenues ?? 0) }} <span
                                                    class="text-success text-sm">
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="card-body stats welcome-card">
                                                    <div class="row align-items-center">
                                                        <div class="col-xxl-12">
                                                            ...
                                                            <h4 class="f-w-400">
                                                                <a href="{{ asset(!empty(auth()->user()->profile_image) ? 'storage/'.auth()->user()->profile_image : Storage::url('uploads/profile/avatar.png')) }}"
                                                                    target="_blank">
                                                                    <img src="{{ asset(!empty(auth()->user()->profile_image) ? 'storage/'.auth()->user()->profile_image : Storage::url('storage/uploads/profile/avatar.png')) }}"
                                                            ...
                                                            <div class="dropdown quick-add-btn">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    ...
                                                                    <a href="#" data-size="md"
                                                                        data-url="{{ route('taxes.create') }}" data-ajax-popup="true"
