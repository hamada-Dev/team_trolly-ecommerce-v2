        ...
        @foreach ($response->data->data as $item)
          <div class="mini-wish-item">
             <div class="mini-wish-image">
                <a href="{{route('page.product', ['storeSlug' => $slug, 'product_slug' => $item->product_data->slug])}}" title="SPACE BAG">
                   <img src="{{ asset($item->product_image) }}" alt="plant1">
                </a>
             </div>
             <div class="mini-wish-details" style="color: black;">
                <p class="mini-wish-title"><a href="{{route('page.product', ['storeSlug' => $slug, 'product_slug' => $item->product_data->slug])}}"> {{$item->product_name}}</a></p>
