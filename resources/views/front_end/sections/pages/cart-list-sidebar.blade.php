        ...
        @if (!empty($response->data->cart_total_product))
            ...
            <div class="mini-cart-item">
                <div class="mini-cart-image">
                    ...
                    <a href="{{route('page.product', [$slug,$item->product_id])}}">
                        <img src="{{get_file($item->image , APP_THEME())}}" alt="img">
                    </a>
                </div>
                <div class="mini-cart-details">
                    <p class="mini-cart-title"><a href="{{route('page.product', [$slug,$item->product_id])}}">{{ $item->name }}</a></p>
    ...
    <div class="mini-cart-footer mini-cart-footer1">
        @if (!empty($response->data->cart_total_product))
            <div class="u-save d-flex justify-end">
                {{ __("Subtotal") }}: {{  SetNumberFormat($response->data->final_price ?? ($response->data->sub_total ?? 0)) }}
            </div>
            <div class="u-save d-flex justify-end">
