                                        ...
                                        <div class="setting-card">
                                            <div class="logo-content mt-4">
                                                <a href="#" target="_blank">
                                                    <img src="{{ !empty($setting['logo_dark']) ? $setting['logo_dark'] . '?timestamp=' . time() : $profile . '/logo-dark.png' . '?timestamp=' . time() }}"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class=" setting-card">
                                            <div class="logo-content mt-4">
                                                <a href="#" target="_blank">
                                                    <img src="{{ !empty($setting['logo_light']) ? $setting['logo_light'] . '?timestamp=' . time() : $profile . '/logo-dark.png' . '?timestamp=' . time() }}"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class=" setting-card">
                                            <div class="logo-content mt-4">
                                                <a href="#" target="_blank">
                                                    <img src="{{ !empty($setting['favicon']) ? $setting['favicon'] . '?timestamp=' . time() : $profile . '/logo-dark.png' . '?timestamp=' . time() }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row ms-1">
                                        <div class="form-check col-md-6">
                                            ...
                                            id="flexCheckDefault"  @if(empty($setting['site_currency_symbol_position']) || $setting['site_currency_symbol_position'] == 'pre') checked @endif>
                                        ...
                                        <div class="form-check col-md-6">
                                            ...
                                            id="flexCheckChecked" @if(empty($setting['site_currency_symbol_position']) || $setting['site_currency_symbol_position'] == 'post') checked @endif>
                                                        ...
                                                        <div class="col-md-6 text-end">
                                                            ...
                                                            <div class="form-check form-switch d-inline-block">
                                                                {!! Form::checkbox(
                                                                    'is_paypal_enabled',
                                                                    'on',
                                                                    isset($setting['is_paypal_enabled']) ?? $setting['is_paypal_enabled'],
                                                                    [
                                                                        'class' => 'form-check-input',
