                            ...
                            @foreach (config('translation.languages') as $code => $language)
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        {!! Form::text("name[$code]", $product->getTranslations('name')[$code], ['class' => 'form-control name']) !!}
                                    </div>
                                </div>
                            @endforeach
                ...
                <div class="col-lg-4 col-12">
                    ...
                    <div class="card border">
                        <div class="card-body">
                            @foreach (config('translation.languages') as $code => $language)
                                <div class="form-group">
                                    {{ Form::label('description', __($language['label']) .' '. __('Product Description'), ['class' => 'form-label']) }}
                                    {{ Form::textarea("description[$code]", $product->getTranslations('description')[$code], ['class' => 'form-control  ummernote-simple-product', 'rows' => 1, 'placeholder' => __('Product Description'), 'id' => 'description']) }}
                                </div>
                            @endforeach
                            @foreach (config('translation.languages') as $code => $language)
                                <div class="form-group">
                                    {{ Form::label('specification', __($language['label']) .' '. __('Product Specification'), ['class' => 'form-label']) }}
                                    {{ Form::textarea("specification[$code]", $product->getTranslations('specification')[$code], ['class' => 'form-control  ummernote-simple-product', 'rows' => 1, 'placeholder' => __('Product Specification'), 'id' => 'specification']) }}
                                </div>
                            @endforeach
                            @foreach (config('translation.languages') as $code => $language)
                                <div class="form-group">
                                    {{ Form::label('detail', __($language['label']) .' '. __('Product Detail'), ['class' => 'form-label']) }}
                                    {{ Form::textarea("detail[$code]", $product->getTranslations('detail')[$code], ['class' => 'form-control  ummernote-simple-product', 'rows' => 1, 'placeholder' => __('Product Detail'), 'id' => 'detail']) }}
                                </div>
                            @endforeach
                        </div>
                    </div>
                                            ...
                                            <div id="custom_field_repeater_basic">
                                                ...
                                                <div class="form-group">
                                                    <div data-repeater-list="custom_field_repeater_basic">
                                                        @if (!empty($product->custom_field) && is_array($product->custom_field))
