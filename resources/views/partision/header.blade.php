                ...
                <a class="dash-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#"
                    ...
                    <span class="theme-avtar">
                        <img alt="#" style="height:inherit;"
                            src="{{ !empty(auth()->user()->profile_image) ? asset('storage/'.auth()->user()->profile_image) : asset(Storage::url('storage/uploads/profile/avatar.png')) }}"
                            class="header-avtar">
        ...
        <ul class="list-unstyled">
                ...
                @if (auth()->user()->type == 'admin')
                    <li class="dash-h-item drp-language menu-lnk has-item">
                        @php
                            $activeStore = Session::get('demo_store') ?? auth()->user()->current_store;
                ...
                <div class="dropdown-menu dash-h-dropdown dropdown-menu-end">
                    @foreach ($displaylang as $key => $lang)
                        ...
                        <a href="{{ route('change.language', $key) }}"
                            class="dropdown-item {{ auth()->user()->language == $key ? 'text-primary' : '' }}">
