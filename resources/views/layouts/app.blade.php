@php
    ...
    if (!isset($currantLang)) {
        ...
        $setting['currantLang']=$currantLang;
    }
...
<head>
    ...
    <title>{{ isset($setting['title_text']) ? $setting['title_text'] : 'Ecommercego saas' }} - @yield('page-title') </title>
...
<body class="{{ $setting['color'] ?? 'theme-3'}}">
