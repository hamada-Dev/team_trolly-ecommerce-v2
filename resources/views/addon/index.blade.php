        ...
        <div class="product-card ">
            <div class="product-card-inner">
                <div class="product-card-image img-wrapper">
                    <a href="{{ asset('themes/'.$value->theme_id.'/theme_img/img_1.png') }}" class="pdp-img"
                    ...
                    <div class="checkbox-custom">
                        <div class="btn-group card-option">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" style="">
                                ...
                                {!! Form::open(['method' => 'DELETE', 'route' => ['addon.destroy', $value->theme_id],
                                'class' => 'd-inline']) !!}
                ...
                <div class="product-content">
                    <div class="product-content-top">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-2">
                            ...
                            <!-- <a href="#" target="_new" class="btn btn-outline-primary btn-sm"><i class="fa fa-download"
                    ...
                    <div class="product-content-bottom d-flex gap-2">
                        ...
                        <a href="{{ $value[3] }}?utm_source=ecom-main-file&utm_medium=superadmin&utm_campaign=superadmin-btn-theme-{{ $value[0] }}"
                            target="_new" class="btn btn-outline-primary w-100 mt-2">{{ __('View Details') }}</a>
                    </div>
                </div>
            </div>
        </div>
