{{ Form::model($blogCategory, ['route' => ['blog-category.update', $blogCategory->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
...
<div class="row">
    ...
    @foreach (config('translation.languages') as $code => $language)
        <div class="form-group col-12">
            ...
            {!! Form::text("name[$code]", $blogCategory->getTranslations('name')[$code], ['class' => 'form-control font-style', 'required' => 'required']) !!}
        </div>
    @endforeach
