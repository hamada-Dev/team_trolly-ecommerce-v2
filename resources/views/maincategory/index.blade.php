                ...
                <table class="table dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $Category->name }}</td>
                            <td>
                                <img src="{{ $Category->image_path ? get_file(@$Category->image_path , APP_THEME()) : '' }}" alt="" class="category_Image">
                            </td>
                            <td> <img src="{{ $Category->icon_path ?  get_file(@$Category->icon_path , APP_THEME()):'' }}" alt="" class="category_Image"> </td>
