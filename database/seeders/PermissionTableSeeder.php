...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($superadmin_permission  as $key => $value)
        {
            ...
            if($superAdminRole && !$superAdminRole->hasPermission($value))
            {
        ...
        foreach ($admin_permission as $key => $value)
        {
            ...
            if($admin_role && !$admin_role->hasPermission($value))
            {
                $admin_role->givePermission($permission);
            }
        }
        ...
        if($admin_role && !$assigned_role && !empty($company))
        {
