...
class SettingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($user->type == 'super admin') {
            ...
            return view('setting.index', compact('timezones','setting', 'user', 'webhooks', 'emailTemplates',  'store_settings', 'pwa_data','PixelFields','taxes','tax_option', 'WhatsappNotification','plan'));
        }

        return view('setting.index', compact('user', 'setting','timezones', 'countries', 'country_id', 'states', 'state_id', 'cities', 'filter_data'));
    }
