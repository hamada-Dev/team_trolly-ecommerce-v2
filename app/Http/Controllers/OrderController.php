...
class OrderController extends Controller
{
    ...
    public function order_view(Request $request, $id)
    {
        // if (auth()->user()->isAbleTo('Show Order')) {
            try {
                ...
                return view('order.view', compact('order','store','order_notes'));
    ...
    public function order_summary(Request $request, $slug)
    {
        ...
        elseif((isset($request['data']['order_id']) && !empty($request['data']['order_id'])) || (isset($request->responce['data']['order_id']) && ($request->responce['data']['order_id'])))
        {
            ...
            return view('front_end.sections.pages.order-summary',compact('store','order_data','slug','currentTheme','currantLang','currency','languages','section','order_complate_description','order_complate_title'));
        }else{
