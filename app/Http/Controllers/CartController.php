...
class CartController extends Controller
{
    public function cart_list_sidebar(Request $request, $storeSlug)
    {
        ...
        if ($response->status == 1) {
            ...
            $return['html'] = view('front_end.sections.pages.cart-list-sidebar', compact('slug', 'response', 'currency', 'currency_name','tax_option','currentTheme'))->render();
            $return['checkout_html'] = view('front_end.sections.pages.cart-list', compact('slug', 'response', 'currency', 'currency_name','tax_option','currentTheme'))->render();
            $return['checkout_html_2'] = view('front_end.sections.pages.checkout-cart-list', compact('slug', 'response', 'currency', 'currency_name','tax_option','currentTheme'))->render();
            $return['checkout_html_products'] = view('front_end.sections.pages.checkout-product-list', compact('response', 'currency', 'currency_name'))->render();
            $return['checkout_amounts'] = view('front_end.sections.pages.checkout-amount', compact('response', 'currency', 'currency_name'))->render();
