...
class ThemeSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('theme_preview.index',compact('themes', 'currentTheme'));
    }
    ...
    /**
     * Get section data based on publication status and section models
     */
    // private function getDatabaseSection($is_publish, $sectionModel, $draftModel, $request)
    // {
    //     if ($is_publish) {
    //         return $sectionModel->where('theme_id', $request->theme_id)
    //             ->where('store_id', $request->store_id)
    //             ->where('section_name', $request->section_name)
    //             ->value('theme_json');
    //     } else {
    //         $data = $draftModel->where('theme_id', $request->theme_id)
    //             ->where('store_id', $request->store_id)
    //             ->where('section_name', $request->section_name)
    //             ->value('theme_json');
    //         if (!$data) {
    //             $data =$sectionModel->where('theme_id', $request->theme_id)
    //             ->where('store_id', $request->store_id)
    //             ->where('section_name', $request->section_name)
    //             ->value('theme_json');
    //         }
