...
Route::get('{storeSlug}/contact_us', [HomeController::class, 'contact_us'])->name('page.contact_us')->middleware('themelanguage');
Route::any('{storeSlug}/blogs/filter/view', [BlogController::class, 'blog_filter'])->name('blogs.filter.view')->middleware('themelanguage');
...
Route::middleware([ActiveTheme::class, 'themelanguage'])->group(function () {
    ...
    Route::get('/{storeSlug}/{slug}', [ThemeSettingController::class, 'page'])->where('slug', '.*')->name('themes.page');  
