                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                @foreach (config('translation.languages') as $code => $language)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {{ Form::label('Offer Text', __($language['label']) . ' ' . __('Offer Text'), ['class' => 'form-label']) }}
                                            {{ Form::text("home_offer_text[$code]", $settings['home_offer_text_translation']->getTranslations('value')[$code] ?? $settings['home_offer_text'], ['class' => 'form-control', 'placeholder' => __('70% Special Offer')]) }}
                                            @error('mail_host')
                                ...
                                @foreach (config('translation.languages') as $code => $language)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text("home_title[$code]", $settings['home_title_translation']->getTranslations('value')[$code] ?? $settings['home_title'], ['class' => 'form-control', 'placeholder' => __('Enter Title')]) }}
                                            @error('mail_host')
                                                <span class="invalid-mail_port" role="alert">
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                </span>
                                ...
                                @foreach (config('translation.languages') as $code => $language)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text("home_heading[$code]", $settings['home_heading_translation']->getTranslations('value')[$code] ?? $settings['home_heading'], ['class' => 'form-control', 'placeholder' => __('Enter Heading')]) }}
                                            @error('mail_host')
                                                <span class="invalid-mail_port" role="alert">
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                </span>
                                ...
                                @foreach (config('translation.languages') as $code => $language)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {{ Form::label('Trusted by', __($language['label']) . ' ' . __('Trusted by'), ['class' => 'form-label']) }}
                                            {{ Form::text("home_trusted_by[$code]", $settings['home_trusted_by_translation']->getTranslations('value')[$code] ?? $settings['home_trusted_by'], ['class' => 'form-control', 'placeholder' => __('1,000+ customers')]) }}
                                            @error('mail_host')
                                                <span class="invalid-mail_port" role="alert">
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                </span>
                                ...
                                @foreach (config('translation.languages') as $code => $language)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text("home_description[$code]", $settings['home_description_translation']->getTranslations('value')[$code] ?? $settings['home_description'], ['class' => 'form-control', 'placeholder' => __('Enter Description')]) }}
                                            @error('mail_host')
                                                <span class="invalid-mail_port" role="alert">
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                </span>
                                ...
                                @foreach (config('translation.languages') as $code => $language)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {{ Form::label('Live Demo Link', __($language['label']) . ' ' . __('Live Demo Link'), ['class' => 'form-label']) }}
                                            {{ Form::text("home_live_demo_link[$code]", $settings['home_live_demo_link_translation']->getTranslations('value')[$code] ?? $settings['home_live_demo_link'], ['class' => 'form-control', 'placeholder' => __('Enter Link')]) }}
                                            @error('mail_host')
                                                <span class="invalid-mail_port" role="alert">
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                </span>
                                ...
                                @foreach (config('translation.languages') as $code => $language)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {{ Form::label('Buy Now Link', __($language['label']) . ' ' . __('Buy Now Link'), ['class' => 'form-label']) }}
                                            {{ Form::text("home_buy_now_link[$code]", $settings['home_buy_now_link_translation']->getTranslations('value')[$code] ?? $settings['home_buy_now_link'], ['class' => 'form-control', 'placeholder' => __('Enter Link')]) }}
                                            @error('mail_host')
                                                <span class="invalid-mail_port" role="alert">
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                </span>
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-auto">
                                                            <p class="card-text small text-muted">
                                                                <img class="rounded" src="{{ $logo . '/placeholder.png' }}"
                                                ...
                                                <div class="card mb-3 border shadow-none product_Image">
                                                    <div class="px-2 py-2">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-auto actions">
                                                                <a class="action-item btn btn-sm btn-icon btn-info"
                                                            ...
                                                            <div class="col-auto actions">
                                                                <a class="action-item btn btn-sm btn-icon btn btn-sm btn-danger delete-button "
