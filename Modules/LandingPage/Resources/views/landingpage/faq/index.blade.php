                                ...
                                @foreach (config('translation.languages') as $code => $language)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text("faq_title[$code]", $settings['faq_title_translation']->getTranslations('value')[$code] ?? $settings['faq_title'], ['class' => 'form-control', 'placeholder' => __('Enter Title')]) }}
                                            @error('mail_host')
                                ...
                                @foreach (config('translation.languages') as $code => $language)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text("faq_heading[$code]", $settings['faq_heading_translation']->getTranslations('value')[$code] ?? $settings['faq_heading'], ['class' => 'form-control', 'placeholder' => __('Enter Heading')]) }}
                                            @error('faq_heading')
                                                <span class="invalid-mail_port" role="alert">
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                </span>
                                ...
                                @foreach (config('translation.languages') as $code => $language)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text("faq_description[$code]", $settings['faq_description_translation']->getTranslations('value')[$code] ?? $settings['faq_description'], ['class' => 'form-control', 'placeholder' => __('Enter Description')]) }}
                                            @error('mail_host')
                                                <span class="invalid-mail_port" role="alert">
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                </span>
