                                ...
                                @foreach (config('translation.languages') as $code => $language)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text("joinus_heading[$code]", $settings['joinus_heading_translation']->getTranslations('value')[$code] ?? $settings['joinus_heading'], ['class' => 'form-control', 'placeholder' => __('Enter Description')]) }}
                                ...
                                @foreach (config('translation.languages') as $code => $language)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text("joinus_description[$code]", $settings['joinus_description_translation']->getTranslations('value')[$code] ?? $settings['joinus_description'], ['class' => 'form-control', 'placeholder' => __('Enter Description')]) }}
                                            @error('mail_host')
                                                <span class="invalid-mail_port" role="alert">
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                </span>
