                                        ...
                                        @foreach (config('translation.languages') as $code => $language)
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text("feature_title[$code]", $settings['feature_title_translation']->getTranslations('value')[$code] ?? $settings['feature_title'], ['class' => 'form-control', 'placeholder' => __('Enter Title')]) }}
                                                    @error('mail_host')
                                        ...
                                        @foreach (config('translation.languages') as $code => $language)
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text("feature_heading[$code]", $settings['feature_heading_translation']->getTranslations('value')[$code] ?? $settings['feature_heading'], ['class' => 'form-control', 'placeholder' => __('Enter Heading')]) }}
                                                    @error('mail_host')
                                                        <span class="invalid-mail_port" role="alert">
                                                            <strong class="text-danger">{{ $message }}</strong>
                                                        </span>
                                        ...
                                        @foreach (config('translation.languages') as $code => $language)
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text("feature_description[$code]", $settings['feature_description_translation']->getTranslations('value')[$code] ?? $settings['feature_description'], ['class' => 'form-control', 'placeholder' => __('Enter Description')]) }}
                                                    @error('mail_host')
                                                        <span class="invalid-mail_port" role="alert">
                                                            <strong class="text-danger">{{ $message }}</strong>
                                                        </span>
                                        ...
                                        @endforeach
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text("feature_buy_now_link[$code]", $settings['feature_buy_now_link_translation']->getTranslations('value')[$code] ?? $settings['feature_buy_now_link'], ['class' => 'form-control', 'placeholder' => __('Enter Link')]) }}
                                                    @error('mail_host')
                                                        <span class="invalid-mail_port" role="alert">
                                                            <strong class="text-danger">{{ $message }}</strong>
                                                        </span>
                            ...
                            {{ Form::open(array('route' => 'feature_highlight_create', 'method'=>'post', 'enctype' => "multipart/form-data")) }}
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {{ Form::label('highlight_feature_heading', __($language['label']) . ' ' . __('Heading'), ['class' => 'form-label']) }}
                                                {{ Form::text("highlight_feature_heading[$code]", $settings['highlight_feature_heading_translation']->getTranslations('value')[$code] ?? $settings['highlight_feature_heading'], ['class' => 'form-control', 'placeholder' => __('Enter Heading')]) }}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {{ Form::label('highlight_feature_heading', __($language['label']) . ' ' . __('Description'), ['class' => 'form-label']) }}
                                            {{ Form::text("highlight_feature_description[$code]", $settings['highlight_feature_description_translation']->getTranslations('value')[$code] ?? $settings['highlight_feature_description'], ['class' => 'form-control', 'placeholder' => __('Enter Description')]) }}
