                                    ...
                                    @foreach (config('translation.languages') as $code => $language)
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                {{ Form::text("screenshots_heading[$code]", $settings['screenshots_heading_translation']->getTranslations('value')[$code] ?? $settings['screenshots_heading'], ['class' => 'form-control', 'placeholder' => __('Enter Heading')]) }}
                                    ...
                                    @foreach (config('translation.languages') as $code => $language)
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                {{ Form::text("screenshots_description[$code]", $settings['screenshots_description_translation']->getTranslations('value')[$code] ?? $settings['screenshots_description'], ['class' => 'form-control', 'placeholder' => __('Enter Description')]) }}
                                                @error('mail_host')
                                                    <span class="invalid-mail_port" role="alert">
                                                        <strong class="text-danger">{{ $message }}</strong>
                                                    </span>
