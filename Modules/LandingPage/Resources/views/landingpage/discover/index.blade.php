                                        ...
                                        @foreach (config('translation.languages') as $code => $language)
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text("discover_live_demo_link[$code]", $settings['discover_live_demo_link_translation']->getTranslations('value')[$code] ?? $settings['discover_live_demo_link'], ['class' => 'form-control', 'placeholder' => __('Enter Link')]) }}
                                                    @error('mail_host')
                                                        <span class="invalid-mail_port" role="alert">
                                                            <strong class="text-danger">{{ $message }}</strong>
                                                        </span>
                                        ...
                                        @foreach (config('translation.languages') as $code => $language)
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text("discover_buy_now_link[$code]", $settings['discover_buy_now_link_translation']->getTranslations('value')[$code] ?? $settings['discover_buy_now_link'], ['class' => 'form-control', 'placeholder' => __('Enter Link')]) }}
                                                    @error('mail_host')
                                                        <span class="invalid-mail_port" role="alert">
                                                            <strong class="text-danger">{{ $message }}</strong>
                                                        </span>
