                                    ...
                                    @foreach (config('translation.languages') as $code => $language)
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                {{ Form::label('Site Description', __($language['label']) . ' ' .  __('Site Description'), ['class' => 'form-label']) }}
                                                {{ Form::text("site_description[$code]", $settings['site_description_translation']->getTranslations('value')[$code] ?? $settings['site_description'], ['class' => 'form-control', 'placeholder' => __('Enter Description')]) }}
                                                @error('mail_port')
